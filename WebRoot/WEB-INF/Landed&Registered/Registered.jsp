		...
		<div class="auto_notice_content">
			<div class="regibox">
				<div class="regitop">
					...
					<span class="fr login"> 已有账号 
					      <a href="Landinginterface.jsp">直接登录</a> 
					</span>
				</div>
				<form id="thisForm" class="regi_form" method="post">
					<div class="r_account">
					...
					<div class="r_pasw regi_form">
						<div class="r_pasw1">
							<input type="password" class="stext rg-input ipt-phone fl" name="passWord" id="passWord" value="" placeholder="密码" onKeyUp="CheckIntensity(this.value)" />
							<div class="tipinfo"></div>
						...
						<div class="r_pasw2 regi_form">
							<input type="password" class="stext rg-input ipt-phone fl" name="passWordAgain" id="passWordAgain" value="" placeholder="再次确认密码">
							<div class="tipinfo"></div>
						</div>
					</div>
					...
					<button name="Submit" type="button" onclick="registered()" class="immediate_regi regi_form">立即注册</button>
				</form>
				<div class="clause regi_form">
					<input type="checkbox" checked="checked" class="clause_ipt fl" /> 
					<span class="read_clause fl"> 我已阅读并接受 
					      <a href="../clause.jsp" target="_blank" class="server_clause">凹凸网服务条款</a> 
					</span>
				</div>
			</div>
		</div>
