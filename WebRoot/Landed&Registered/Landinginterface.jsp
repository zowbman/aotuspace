...
<body>
	...
	<div id="land">
		<div class="auto_notice_content">
			<div class="landbox">
				<form id="thisForm" class="land_top regi_form" method="post" action="index.jsp">
					<ul>
						<!-- <li>请登录</li> -->
						<li class="regi_form">
					...
					<div class="land_sub">
						<button type="submit" onclick="login()" value="登陆" class="at_submit regi_form">登陆</button>
					</div>
				</form>
		        <div class="land_center">
					...
					<div class="land_c_r fr">
						<a href="../Retrievepassword/Retrievepassword.jsp">忘记密码?</a>&nbsp;&nbsp;|&nbsp;&nbsp;
