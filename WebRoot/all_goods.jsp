								...
								<dl class=" listIndex" attr="terminal_os_s"
									...
									<dd>
								           <label>
                                                ...
                                                <a href="javascript:;" values2="" values1="" attrval="symbian">花花公子</a>
                                            </label>
                                          <label>
                                              <input name="checkbox2" type="checkbox" value="" autocomplete="off"/>
		...
		<div class="auto_notice_content goods-box">
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						    <img src="images/img/allOrder_31.jpg"> 
						</a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
							<a href=""><nobr>代言主播&nbsp;&nbsp;&nbsp;童可可</nobr></a>
						</div>
						<div class="message">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/allOrder1_03.jpg"> 
					</a>
					<div class="preloader">
				...
				<div class="ctx-box">
					<div class="row-1">
						<a href="Details-Page/Representdetail.jsp"title="2015秋冬季新款纯棉男士T恤薄款修身V领长袖t恤打底衫男式t恤印花">
						    2015秋冬季新款纯棉男士T恤薄款修身V领长袖t恤打底衫男式t恤印花
						</a>
					</div>
					<div class="row-2">
						<a href="">爱马仕</a>
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						   <img src="images/img/allOrder_33.jpg"> 
						</a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/ProductImage/1.jpg"> 
					</a>
					<div class="preloader">
						<div class="status">&nbsp;</div>
					</div>
				...
				<div class="ctx-box">
					<div class="row-1">
						<a href="Details-Page/Representdetail.jsp" title="2015秋冬季新款纯棉男士T恤薄款修身V领长袖t恤打底衫男式t恤印花">2015秋冬季新款纯棉男士T恤薄款修身V领长袖t恤打底衫男式t恤印花</a>
					</div>
					<div class="row-2">
						<a href="">爱马仕</a>
					</div>
					<div class="row-3">
						...
						<div class="mind fr">
							<a href=""> 
							   <img src="images/icon/allOrder13_38.png"> 
							</a>
						</div>
					</div>
				</div>
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
				           <img src="images/img/allOrder_34.jpg"> 
				        </a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/ProductImage/2.jpg"> 
					</a>
					<div class="preloader">
						<div class="status">&nbsp;</div>
					</div>
			...
			<!-- 商品简介结束 -->
			<!-- 商品简介开始 -->
			<div class="a_g_items fl items-dont">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						   <img src="images/img/allOrder_35.jpg"> 
						</a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/ProductImage/10.jpg"> 
					</a>
				</div>
				<div class="ctx-box">
					<div class="row-1">
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						    <img src="images/img/allOrder_36.jpg">
					    </a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp">
					    <img src="images/ProductImage/5.jpg"> 
					</a>
				</div>
				<div class="ctx-box">
					<div class="row-1">
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						   <img src="images/img/allOrder_37.jpg"> 
						</a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
							<a href=""><nobr>代言主播&nbsp;&nbsp;&nbsp;童可可</nobr>
							</a>
						</div>
						<div class="message">
							<a href="" title="小伙伴快来买我的商品，我为自己带盐"><nobr>小伙伴快来买我的商品，我为自己fdsfsdfsd带盐</nobr></a>
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/ProductImage/6.jpg"> 
					</a>
				</div>
				<div class="ctx-box">
					<div class="row-1">
			...
			<div class="a_g_items fl">
				<div class="items_top">
					<div class="i-img fl">
						<a href="" class="imglink"> 
						   <img src="images/img/allOrder_332.jpg"> 
						</a>
					</div>
					<div class="i-text fl">
						<div class="spokesperson">
				...
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					   <img src="images/ProductImage/7.jpg"> 
				    </a>
				</div>
				<div class="ctx-box">
					<div class="row-1">
			...
			<div class="a_g_items fl items-dont">
				<div class="items_top">
					...
					<div class="i-text fl">
						...
						<div class="message">
							<a href="" title="小伙伴快来买我的商品，我为自己带盐">
							    <nobr>小伙伴快来买我的商品，我为自己带盐</nobr>
							</a>
						</div>
					</div>
				</div>
				<div class="productGraph">
					<a class="pic-link" href="Details-Page/Representdetail.jsp"> 
					    <img src="images/ProductImage/8.jpg"> 
					</a>
				</div>
				<div class="ctx-box">
					<div class="row-1">
