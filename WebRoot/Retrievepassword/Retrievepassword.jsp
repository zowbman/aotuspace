		...
		<div class="auto_notice_content">
			<div class="rp_box">
				...
				<div class="rp_list_box">
						...
						<ul>
							<li>
								<div class="rp_list_all">
									<div class="rp_list_img" style="margin-left:24px;"></div>
									<div class="rp_list_accinfo">填写账号信息</div>
								</div></li>
							<li>
								<div class="rp_list_all">
									<div class="rp_list_img_grey">2</div>
					...
					<div class="rp_form">
						<form>
							<input type="text" placeholder="账号" class="_account" />
							<div class="nc_scale">
								<div class="_bg"></div>
								<span></span>
						...
						<a href="Retrievepassword-verify.jsp" class="next-step">下一步</a>
					</div>
					<!-- 表单填写结束 -->
				</div>
			</div>
		...
		<div class="footercontent">
			<div class="footer_edition" style="text-align:center;">
				<span>COPYRIGHT &copy; 2015 aotuspace.com , ALL RIGHT
					RESERVED <a href="">版权所有</a> 凹凸空间</span>
			</div>
		</div>
	</div>
	<!-- 底部结束 -->
